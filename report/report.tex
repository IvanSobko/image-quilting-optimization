...
This loop reordering further allows us to block both iterating over the pixels of the overlap region as well as block iterating over pixels of the source texture, as we will discuss later.
