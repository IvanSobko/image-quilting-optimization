...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.30]{fig/DependencyGraph.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.18]{fig/Unrolling.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.4]{fig/PerfBasic.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.4]{fig/BenchmarkPerformance.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.4]{fig/PerfUnroll.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.25]{fig/RooflineUnroll.pdf}
...
\begin{figure}[htb]
  \centering
    \includegraphics[scale=0.3]{fig/RooflineBlocking.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.4]{fig/VectorizePlot.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.4]{fig/VectorizeBlockingPlot.pdf}
...
\begin{figure}[htb]
  \centering
    \includegraphics[scale=0.4]{fig/248Performances.pdf}
