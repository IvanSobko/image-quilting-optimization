...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.30]{DependencyGraph.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.4]{PerfBasic.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.4]{BenchmarkPerformance.pdf}
...
\begin{figure}[htb]
\centering
  \includegraphics[scale=0.4]{PerfUnroll.pdf}
...
\begin{figure}[htb]
  \centering
    \includegraphics[scale=0.4]{248Performances.pdf}
