...
void run_timing_functional(const std::string& label, const std::string& inputDirectory, const std::string& filenameFilter,
                           const std::string& outputDirectory, const ImageQuiltingFunction& imageQuiltingFunction,
                           int outputScale, int blockDivisor, int seed);
